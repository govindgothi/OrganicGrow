    ...
    <>
      <div className={styles.DisplaySingleProduct_Containet}>
        <div className={styles.RightBox}>
          ...
          <img src="https://images.meesho.com/images/products/220335758/q4pui_1200.jpg" alt="" width={"100%"} height={"100%"}/>
          </div>
          <div className={styles.ShowImageOption}>
            <div className={styles.Imageindex}><img src="https://images.meesho.com/images/products/220335758/q4pui_1200.jpg" alt="" width={"100%"} height={"100%"}/></div>
            <div className={styles.Imageindex}><img src="https://images.meesho.com/images/products/220335758/q4pui_1200.jpg" alt="" width={"100%"} height={"100%"}/></div>
            <div className={styles.Imageindex}><img src="https://images.meesho.com/images/products/220335758/q4pui_1200.jpg" alt="" width={"100%"} height={"100%"}/></div>
            <div className={styles.Imageindex}><img src="https://images.meesho.com/images/products/220335758/q4pui_1200.jpg" alt="" width={"100%"} height={"100%"}/></div>
          </div>
